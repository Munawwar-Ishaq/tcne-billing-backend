...
const updateUser = async (user) => {
  try {
    ...
    let amountPaid = parseFloat(UpdatedUser.amountPaid || 0);
    ...
    console.log("discount:", amountPaid);
    console.log("====================================");
    ...
    let advanceBalanced =
      parseFloat(UpdatedUser.amountPaid || 0) > 0
        ? parseFloat(UpdatedUser.amountPaid || 0)
        : 0;
